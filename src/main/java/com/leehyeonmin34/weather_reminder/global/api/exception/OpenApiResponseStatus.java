...
@AllArgsConstructor
@Getter
public enum OpenApiResponseStatus {
    ...
    public static OpenApiResponseStatus of(String code){
        return Arrays.stream(OpenApiResponseStatus.values())
                .filter(item -> item.getCode().equals(code))
                .findAny()
                .orElseThrow(() -> new InvalidEnumCodeException(OpenApiResponseStatus.class, code));
    }
